...
export interface RechnungEmailProps {
  anrede: string;
  vorname: string;
  name: string;
...
export function RechnungEmail({
  ...
  return (
    <Html lang="de">
      <Head />
      <Preview>
        Rechnung Nr. {rechnungsNr} – {workshopTitle}
      </Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Text style={text}>
            Im Anhang finden Sie die Rechnung für Ihre Anmeldung zum folgenden
            Kurs:
          </Text>
          ...
          <Text style={text}>
            Bitte begleichen Sie den Betrag bis in 14 Tagen gemäss den Angaben
            auf der Rechnung.
          </Text>
