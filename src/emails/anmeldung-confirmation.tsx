...
export interface AnmeldungConfirmationProps {
  anrede: string;
  vorname: string;
  name: string;
...
export function AnmeldungConfirmation({
  anrede,
  vorname,
  name,
  workshopTitle,
  ...
  termine,
  preis,
}: AnmeldungConfirmationProps) {
  const salutation = anrede === "Herr" ? `Sehr geehrter Herr ${name}` : `Sehr geehrte Frau ${name}`;

  return (
    <Html lang="de">
      <Head />
      <Preview>Anmeldebestätigung – {workshopTitle}</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Text style={text}>
            Vielen Dank für Ihre Anmeldung. Wir haben Ihre Anmeldung für den
          ...
          <Section style={card}>
            ...
            {preis != null && (
              <Text style={detail}>
                <strong>Kursgebühr:</strong> CHF {preis.toFixed(2)}
              </Text>
            )}
          </Section>

          <Text style={text}>
            Wir werden uns in Kürze bei Ihnen melden, um Ihre Anmeldung zu
            bestätigen und weitere Informationen zuzusenden.
          </Text>
          ...
          <Text style={footer}>
            ...
            zweitsprache.ch
            <br />
            <a href="mailto:info@zweitsprache.ch" style={link}>
              info@zweitsprache.ch
            </a>
          </Text>
        </Container>
      </Body>
...
export default AnmeldungConfirmation;
