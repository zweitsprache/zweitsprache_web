...
export interface VorbereitungsaufgabeEmailProps {
  anrede: string;
  vorname: string;
  name: string;
...
export function VorbereitungsaufgabeEmail({
  anrede,
  vorname,
  name,
  workshopTitle,
  ...
  termine,
  message,
}: VorbereitungsaufgabeEmailProps) {
  const salutation =
    anrede === "Herr"
  ...
  return (
    <Html lang="de">
      <Head />
      <Preview>Vorbereitungsaufgabe – {workshopTitle}</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Text style={text}>
            Im Vorfeld des folgenden Kurses möchten wir Ihnen eine
            Vorbereitungsaufgabe zukommen lassen:
          </Text>
          ...
          <Section style={taskBox}>
            <Text style={taskText}>{message}</Text>
          </Section>
...
export default VorbereitungsaufgabeEmail;
